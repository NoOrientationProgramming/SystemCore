...
![macOS](https://img.shields.io/github/actions/workflow/status/fractal-programming/SystemCore/macos.yml?style=plastic&logo=apple&label=macOS)
![FreeBSD](https://img.shields.io/github/actions/workflow/status/fractal-programming/SystemCore/freebsd.yml?style=plastic&logo=freebsd&label=FreeBSD)
![ARM, RISC-V & MinGW](https://img.shields.io/github/actions/workflow/status/fractal-programming/SystemCore/cross.yml?style=plastic&logo=gnu&label=ARM%2C%20RISC-V%20%26%20MinGW)
...
To implement a new process you can use the provided shell scripts on linux: [cppprocessing.sh](https://github.com/fractal-programming/SystemCore/blob/main/tools/cppprocessing.sh) / [cppprocessing_simple.sh](https://github.com/fractal-programming/SystemCore/blob/main/tools/cppprocessing_simple.sh)
